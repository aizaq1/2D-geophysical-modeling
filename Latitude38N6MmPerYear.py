...
Model.outputDir="outputs_tutorial2_38_6cmperyear"
...
Model.set_velocityBCs(left=[(-6.0) * u.millimeter / u.year, 0.0 * u.millimeter / u.year],
...
Model.run_for(10000000.* u.years, checkpoint_interval=100000. * u.years,dt=100000.0*u.years)
