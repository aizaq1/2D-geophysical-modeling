...
Model.outputDir="outputs_tutorial2_38_20cmperyear_Rightpull"
...
DATA = GIS.MakeStructure(threeD=False,twoD_lat=38.0,Model=Model,Moho='moho_data.txt',Topo='topo_data.txt',min_lat=27,max_lat=44,min_long=-118,max_long=-109,resolution_long=0.03333333333,resolution_lat=0.1,elsl=15,dcp=-75,mat=0,sat=5.,structure_resolution=5)
...
Model.set_velocityBCs(left=[(0.0) * u.millimeter / u.year, 0.0 * u.millimeter / u.year],
                       right=[20.0 * u.millimeter / u.year, 0.0 * u.millimeter / u.year],
...
Model.run_for(3000000.* u.years, checkpoint_interval=100000. * u.years,dt=100000.0*u.years)
