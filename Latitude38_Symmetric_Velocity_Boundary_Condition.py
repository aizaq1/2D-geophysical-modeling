...
Model.outputDir="outputs_tutorial_symmetric"
...
DATA = GIS.MakeStructure(threeD=False,twoD_lat=38.0,Model=Model,Moho='moho_data.txt',Topo='topo_data.txt',min_lat=27,max_lat=44,min_long=-118,max_long=-109,resolution_long=0.03333333333,resolution_lat=0.1,elsl=15,dcp=-75,mat=0,sat=5.,structure_resolution=1)
...
Model.set_velocityBCs(left=[(-1.0) * u.millimeter / u.year, 0.0 * u.millimeter / u.year],
                       right=[1.0 * u.millimeter / u.year, 0.0 * u.millimeter / u.year],
...
# Model.run_for(3000.* u.years, checkpoint_interval=1000. * u.years,dt=1000.0*u.years)
